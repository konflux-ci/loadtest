...
func init() {
	...
	rootCmd.Flags().StringVar(&opts.ReleaseOciStorage, "release-ociStorage", "quay.io/rhtap-perf-test/perf-release-service-trusted-artifacts", "ociStorage path used in the release pipelinerun")
